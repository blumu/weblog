...
type TemplateBaseExtensions<'T>() =
    ...
    member x.EntryId
        with get() = defaultArg (x.tryGetViewBagValue<string> "EntryId") ""
        and set value = x.trySetViewBagValue<string> "EntryId" value
    member x.LegacyViews
        with get() = defaultArg (x.tryGetViewBagValue<int> "LegacyViews") 0
        and set value = x.trySetViewBagValue<int> "LegacyViews" value
    member x.Meta
